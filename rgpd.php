...
<div class="fil-ariane1">
    ...
    <a href="/views/backend/login.php" class="liens-ariane">Mentions légales / RGPD / CGU</a>
</div>
    ...
    <div class="row col-11">
        <div class="texte-intro">
            <p class="texte-paragraphe">Lors de l’inscription sur le site,
                ...
                sur la protection des données</b> du 25 mai 2018 détaillés ci-dessous et à les accepter.</p>
            <p class="texte-paragraphe">Dans le cas contraire, 
                l’utilisateur ne pourra pas se créer de compte et utiliser les fonctionnalités du site demandant la création d’un compte.</p>
            <p class="texte-paragraphe">Accepter les Conditions générales d’utilisation et le <b>Règlement général 
                sur la protection des données</b> équivaut à la signature et l’acceptation de l’utilisateur de<b> tous</b> les articles des règlements et conditions mentionnés.</p>
        </div>

        <div>
            <h1>Mentions légales</h1>
            <p><b>Éditeur de contenu :</b>&nbsp; Le groupe d'étudiants MMI (Métiers du Multimédia et de l'Internet) Natica</p>
            <p><b>Directeur de publication :</b>&nbsp;  Alban Pichon, directeur de l'IUT Bordeaux Montaigne</p>
            <br>
            <br>
            <p><b>Mentions légales</b>, d’après la Loi pour la confiance dans l’économie du numérique (LCEN) de 2004.</p>
            <br>
            <p><b>Adresse :&nbsp;</b> 1 Rue Jacques Ellul, 33800 Bordeaux</p>
            <p><b>Adresse e-mail :</b>&nbsp; webmaster-iut@u-bordeaux-montaigne.fr</p>
            <p><b>Numéro de téléphone :</b>&nbsp; +33 5 57 12 20 44</p>
            ...
            <div class="sous-titre-mentions-legales">Règlement Général sur la Protection des Données (RGPD)</div>
            <br>
            <p>Conformément à la <b>loi n°78-17</b> du 6 janvier relative à l’informatique, aux fichiers et aux libertés, 
            ...
            [webmaster-iut@u-bordeaux-montaigne.fr](mailto:webmaster-iut@u-bordeaux-montaigne.fr)
            pour le bon <b>fonctionnement</b> de votre compte sur le site et seront communiquées au seul destinataire suivant : Marlène Dulaurans.</p>
            <p>Vous pouvez accéder aux données vous concernant, les rectifier, 
            demander leur effacement ou exercer votre droit à la limitation du traitement de vos données.</p>
            <p>Suivant la <b>loi Informatique et Libertés</b> en date du 6 janvier 1978, <b>articles 39 et 40</b>, 
            les données sont <b>conservées</b> à compter de l’achèvement de la base et jusqu’à l’issue d’une période de 15 ans à partir du 1er janvier de l’année qui suit la date d’achèvement.</p>
            <p>D’après le droit à la <b>portabilité des données</b>, vous pourrez <b>récupérer</b> les données qu’elle a fournies sous une forme aisément réutilisable.</p>
            <p>Les <b>mineurs</b> (moins de 16 ans) devront avoir un <b>consentement recueilli auprès de l’autorité parentale</b>.</p>
            <br>
            <p>Pour exercer ces droits ou pour toute question sur le traitement de vos données dans ce dispositif, 
            vous pouvez contacter notre délégué à la protection des données ou le service chargé de l’exercice de ces droits : </p>
            <br>
            ...
            <br>
            <br>
            <p>Si vous estimez, après nous avoir contactés, que vos droits « <b>Informatique et Libertés</b> » ne sont pas respectés, 
            vous pouvez adresser une réclamation à la <b>CNIL</b>. </p>
            <br>
        </div>
    </div>
...
<div class="logo-fin-mentions-legales">
    <img src="/images/eXim-logo.svg" alt="Logo eXim">
</div>
